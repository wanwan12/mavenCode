                ...
                public void onTick(long millisUntilFinished) {
                    if (DIALOG_STYLE_CURRENT == DIALOG_STYLE_LOADING) {
                        ...
                        if (progressColors != null) {
                            switch (count % 7) {
                                case 0:
                                    mProgressHelper.setBarColor(progressColors.length >= 1 ? progressColors[0] : context.getResources().getColor(R.color.blue_btn_bg_color));
                                    break;
                                case 1:
                                    mProgressHelper.setBarColor(progressColors.length >= 2 ? progressColors[1] : context.getResources().getColor(R.color.material_deep_teal_50));
                                    break;
                                case 2:
                                    mProgressHelper.setBarColor(progressColors.length >= 3 ? progressColors[2] : context.getResources().getColor(R.color.success_stroke_color));
                                    break;
                                case 3:
                                    mProgressHelper.setBarColor(progressColors.length >= 4 ? progressColors[3] : context.getResources().getColor(R.color.material_deep_teal_20));
                                    break;
                                case 4:
                                    mProgressHelper.setBarColor(progressColors.length >= 5 ? progressColors[4] : context.getResources().getColor(R.color.material_blue_grey_80));
                                    break;
                                case 5:
                                    mProgressHelper.setBarColor(progressColors.length >= 6 ? progressColors[5] : context.getResources().getColor(R.color.warning_stroke_color));
                                    break;
                                case 6:
                                    mProgressHelper.setBarColor(progressColors.length >= 7 ? progressColors[6] : context.getResources().getColor(R.color.success_stroke_color));
                                    break;
                            }
                        } else {
                            switch (count % 7) {
...
//        }
     ...
     * @return
     */
    public CBDialogBuilder setAVLoadingColor(int color) {
        if (dialogMsg != null && mAVIndicatorView != null) {
            mAVIndicatorView.setIndicatorColor(color);
        }
        return this;
    }
