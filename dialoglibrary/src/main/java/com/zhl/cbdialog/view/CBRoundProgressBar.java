...
public class CBRoundProgressBar extends
		CBHorizontalProgressBar
{
	/**
	 * mRadius of view
	 */
	...
	public CBRoundProgressBar(Context context)
	{
		this(context, null);
	}

	public CBRoundProgressBar(Context context, AttributeSet attrs)
	{
		super(context, attrs);

		mReachedProgressBarHeight = (int) (mUnReachedProgressBarHeight * 2.5f);
		TypedArray ta = context.obtainStyledAttributes(attrs,
				R.styleable.CBHorizontalProgressBar);
		mRadius = (int) ta.getDimension(
				R.styleable.CBRoundProgressBar_cb_radius, mRadius);
		ta.recycle();
